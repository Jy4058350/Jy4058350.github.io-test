    ...
    var CollectionSection = /*#__PURE__*/function () {
      ...
      _createClass(CollectionSection, [{
        ...
        value: function _setupAnimation() {
          ...
          if (forceLoadFromTop) {
            this.timeline.clear();
            this.timeline.staggerFromTo(this.element.querySelectorAll('.ProductList .ProductItem'), 0.25, {
              autoAlpha: 0,
              y: 25
            }, {
              autoAlpha: 1,
      ...
      (function () {
        ...
        documentDelegate.on('click', '[href^="#"], [data-href]', function (event, target) {
          ...
          var element = document.querySelector(selector),
              height = document.getElementById('section-header'),
              offset = parseInt(height.clientHeight || 0),
              offsetTop = element.offsetTop - offset;
