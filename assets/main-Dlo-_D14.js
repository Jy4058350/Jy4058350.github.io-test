...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function p_(){return new Ji({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ud(),fragmentShader:`
		...
		`,blending:vr,depthTest:!1,depthWrite:!1})}function m_(){return new Ji({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ud(),fragmentShader:`
...
`].filter(Xs).join(`
`)),a=xh(a),a=b_(a,t),a=T_(a,t),o=xh(o),o=b_(o,t),o=T_(o,t),a=A_(a),o=A_(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(y=`#version 300 es
